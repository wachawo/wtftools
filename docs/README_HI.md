...
- **स्क्रिप्ट-योग्य** — `-f json` हर कमांड पर काम करता है और `-f plain` (tab-separated) केवल संसाधन और
  ऑडिट व्यू पर; JSON में `schema_version` होता है ताकि स्क्रिप्ट अपग्रेड के बाद भी चलती रहें — grep / awk / jq के लिए।
...
नए हैं? [5-मिनट के quickstart](QUICKSTART.md) से शुरू करें।
...
### हेल्थ और मॉनिटरिंग — [docs/AUDIT.md](AUDIT.md)

| command | यह क्या करता है |
|---------|--------------|
| [`wtf` / `wtf audit`](AUDIT.md#wtf-audit) | क्या ठीक है और क्या नहीं, उसकी हरी/पीली/लाल चेकलिस्ट |
| [`wtf problems`](AUDIT.md#wtf-problems) | केवल WARN+FAIL पंक्तियाँ |
| [`wtf daily`](AUDIT.md#wtf-daily) | सुबह की जाँच: ऑडिट + पिछली बार के मुक़ाबले diff + इवेंट |
| [`wtf explain`](AUDIT.md#wtf-explain) | प्रति-जाँच व्यावहारिक सलाह; LLM को भेजने के लिए `--llm` |
| [`wtf events`](AUDIT.md#wtf-events) | टाइमलाइन: रीबूट, OOM kills, असफल यूनिट, … |
| [`wtf logs`](AUDIT.md#wtf-logs) | सेवा के अनुसार समूहित हाल की ERROR+ journal प्रविष्टियाँ |
| [`wtf services`](AUDIT.md#wtf-services) | एक यूनिट में गहराई से जाएँ: स्थिति, रीस्टार्ट, पोर्ट, journal |
| [`wtf diff`](AUDIT.md#wtf-diff) | वर्तमान स्थिति की तुलना सहेजे गए स्नैपशॉट से करें |
| [`wtf history`](AUDIT.md#wtf-history) | सहेजे गए ऑडिट स्नैपशॉट की सूची बनाएँ |
| [`wtf crontab`](AUDIT.md#wtf-crontab) | सिस्टम + प्रति-उपयोगकर्ता crontab को मान्य करें |
| [`wtf doctor`](AUDIT.md#wtf-doctor) | स्व-निदान: wtf किन उपकरणों/फ़ाइलों का उपयोग कर सकता है |

### संसाधन व्यू — [docs/RESOURCES.md](RESOURCES.md)

| command | यह क्या करता है |
|---------|--------------|
| [`wtf disk [PATH]`](RESOURCES.md#wtf-disk) | माउंट अवलोकन; PATH के साथ, सबसे बड़ी फ़ोल्डर; `--tree` गहराई में जाता है |
| [`wtf cpu`](RESOURCES.md#wtf-cpu) | लोड, iowait, प्रेशर, शीर्ष CPU उपभोक्ता |
| [`wtf mem`](RESOURCES.md#wtf-mem) | RAM/swap, OOM kills, शीर्ष मेमोरी उपभोक्ता |
| [`wtf net`](RESOURCES.md#wtf-net) | इंटरफ़ेस, गेटवे, DNS, त्रुटियाँ, सुनने वाले पोर्ट |
| [`wtf io`](RESOURCES.md#wtf-io) | प्रति-डिवाइस IO दरें, प्रेशर, अटकी हुई प्रक्रियाएँ |
| [`wtf who`](RESOURCES.md#wtf-who) | लॉग-इन उपयोगकर्ता, हाल के लॉगिन, असफल प्रमाणीकरण |
| [`wtf temp`](RESOURCES.md#wtf-temp) | /sys/class/hwmon से हार्डवेयर तापमान |
| [`wtf info`](RESOURCES.md#wtf-info) | एक-पृष्ठ स्नैपशॉट: ऊपर का सब कुछ एक साथ |
| [`wtf top`](RESOURCES.md#wtf-top) | केंद्रित प्रक्रिया top: cpu/rss से सॉर्ट, उपयोगकर्ता/नाम से फ़िल्टर |
| [`wtf ports` / `wtf port N`](RESOURCES.md#wtf-ports) | सुनने वाले सॉकेट; एक पोर्ट में गहराई से जाकर PID, exe, cwd तक |
| [`wtf docker [NAME]`](RESOURCES.md#wtf-docker) | कंटेनर compose dir + image/container/log आकार |

### आउटपुट और कॉन्फ़िगरेशन

| command | यह क्या करता है |
|---------|--------------|
| [`wtf config`](CONFIG.md#wtf-config) | प्रभावी कॉन्फ़िग दिखाएँ / एक टिप्पणी-युक्त उदाहरण प्रिंट करें |
| [`wtf completion`](#install) | bash/zsh `<Tab>`-completion स्क्रिप्ट प्रिंट करें |
| [machine output](OUTPUT.md) | `plain`/`json` फ़ॉर्मेट और एक grep·awk·jq कुकबुक |
...
- [QUICKSTART.md](QUICKSTART.md) — 5-मिनट का ऑनबोर्डिंग और एक चीट शीट
- [AUDIT.md](AUDIT.md) — हेल्थ जाँचें, मॉनिटरिंग, exit कोड, पूरी जाँच सूची
